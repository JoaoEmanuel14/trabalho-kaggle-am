# Trabalho para a Disciplina de Aprendizagem de Máquina - Kaggle

O trabalho foi realizado como avaliação para a disciplina de Aprendizagem de Máquina (COMP0424) do Departamento de Computação da Universidade Federal de Sergipe, ministrada pelo Professor Doutor Hendrik Teixeira Macedo.
